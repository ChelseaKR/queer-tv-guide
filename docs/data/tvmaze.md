...
| Staleness SLA | 48 hours, as for LezWatch.TV. The app shows the "data as of" time, and a next-episode date that has already passed reads as passed, not upcoming. |
