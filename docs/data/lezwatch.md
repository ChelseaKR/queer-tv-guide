...
| Staleness SLA | 48 hours: two missed nightly runs. The app shows every snapshot's "data as of" time. Nothing alarms when the nightly run stops, beyond the failed run in Actions (#25). |
